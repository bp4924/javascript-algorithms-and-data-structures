...
function incrementer() {
  // Only change code below this line
  let newValue = fixedValue + 1; // does not mutate fixedValue
  return newValue;
  // Only change code above this line
}
*/
...
console.log(add(bookList, "El Cid"));
console.log(remove(bookList, "The Hound of the Baskervilles"));
console.log(bookList);
*/
/*
// use map to extract data from an array
// The global variable
const watchList = [
  {
    Title: "Inception",
...
console.log(nonMutatingSlice(cities));
*/
/*
